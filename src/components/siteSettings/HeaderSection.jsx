...
export default function HeaderSection({ data, onChange }) {
  const [form, setForm] = useState({
    ...
    siteTitle: data?.siteTitle || "Make Audit Easy",
  ...
  return (
    <div className="sc">
      <div className="sc-head">
        <h3>
          <LayoutTemplate /> Header &amp; Branding
        </h3>
        <Toggle
      ...
      <div className="sc-body gap16">
        <div className="g2" style={{ alignItems: "start" }}>
          ...
          <div className="fg">
            ...
            <div className="uz" onClick={() => fileRef.current.click()}>
              {logoPreview ? (
                ...
                <>
                  <ImageIcon />
                  <span className="uz-lbl">Upload Preview</span>
                  <small>
                    Recommended SVG or PNG (Transparent) 400×120px minimum size
                  </small>
                </>
              )}
            </div>
          ...
          {/* Favicon/Meta Icon Upload */}
          <div className="fg">
            <span className="fl">Favicon / Meta Icon</span>
            <div className="uz" onClick={() => faviconRef.current.click()}>
              {faviconPreview ? (
                <img
                  src={faviconPreview}
                  alt="favicon"
                ...
                <>
                  <ImageIcon />
                  <span className="uz-lbl">Upload Favicon</span>
                  <small>Recommended 512×512px PNG (Square)</small>
                </>
              )}
            </div>
            <input
        ...
        <div className="gap16">
          <div className="fg">
            <label className="fl">Site Title (Browser Tab)</label>
            <input
              className="fi"
              value={form.siteTitle}
              onChange={(e) => set("siteTitle", e.target.value)}
              placeholder="Make Audit Easy"
            />
          </div>
          ...
          <div className="g2">
            <div className="fg">
              ...
              <input
                className="fi"
                value={form.topNavbarPhone}
                onChange={(e) => set("topNavbarPhone", e.target.value)}
            ...
            <div className="fg">
              ...
              <input
                className="fi"
                value={form.primarySupportEmail}
                onChange={(e) => set("primarySupportEmail", e.target.value)}
                placeholder="support@..."
              />
            </div>
          </div>
        ...
        <div className="fg">
          ...
          <input
            className="fi"
            value={form.stickyAnnouncementText}
            onChange={(e) => set("stickyAnnouncementText", e.target.value)}
            placeholder="Limited Time Offer: Get 20% off..."
          />
        </div>
